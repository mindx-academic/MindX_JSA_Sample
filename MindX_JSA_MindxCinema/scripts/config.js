...
// Kiểm tra tình trạng người dùng để hiển thị user hiện tại.
...
//   // Dùng link API của chính bạn (Vercel sẽ tự hiểu /api/chat là file api/chat.js)
...
//     .then((res) => res.json())
//     .then((data) => {
//       // Thêm dòng này vào để xem lỗi trong tab Console
//       console.log("Dữ liệu trả về từ OpenAI:", data);
//       messageElement.textContent = data.choices[0].message.content.trim();
//     })
//     .catch((error) => {
//       console.error("Lỗi chi tiết:", error); // In lỗi ra Console để kiểm tra
//       messageElement.classList.add("error");
//       // Hiển thị thông báo thân thiện hơn
//       if (error.message && error.message.includes("quota")) {
//         messageElement.textContent =
//           "Hết tiền hoặc chat quá nhanh. Vui lòng đợi 1 phút!";
//       } else {
